...
def document_tool(
    ...
    query: Annotated[str, "A string query to retrieve relevant information from the document"]
) -> str:
    """
    Retrieves relevant information from an attached document based on the provided query.

    This tool checks if a document is attached to the specified chat. If a document is found, 
    it queries the associated vector database for information related to the provided query. 
    If no document is attached, it returns a message indicating this.
